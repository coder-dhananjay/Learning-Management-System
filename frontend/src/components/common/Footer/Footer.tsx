...
import EdWolfLogo from "../../../assets/Logo.svg";
import {
  FaFacebookF,
  FaInstagram,
  FaLinkedinIn,
    ...
    <footer className="w-full bg-blue-50 text-slate-800 dark:bg-slate-950 dark:text-gray-100">
      <div className="container px-4 py-10 md:py-14 max-w-7xl place-self-center">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4">
            <div className="flex items-center gap-2">
              <img src={EdWolfLogo} alt="EdWolf logo" className="h-10 w-10" />
              <span className="text-2xl font-semibold text-slate-800 dark:text-gray-100">
                EdWolf
              </span>
            </div>
          </div>
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-[#1E293B] pt-8 text-slate-800 dark:text-gray-400 md:flex-row">
          <p>&copy; 2026 EdWolf. All rights reserved.</p>
          <div className="flex gap-4">
            <Link
              to={"#"}
              className="dark:hover:text-white hover:text-blue-700"
            >
              Terms
            </Link>
            <Link
